...
- Added navigation buttons and call-to-action flows.
- Built route-based screens for the dashboard, resume upload, and roadmap views.
- Designed a professional career-tech visual style with cards, badges, and dashboard previews.
- Connected page actions to user flows such as resume analysis and sign in.
